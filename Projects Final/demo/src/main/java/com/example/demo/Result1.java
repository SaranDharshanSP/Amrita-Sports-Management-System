...
public class Result1 extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        Image leftImage = new Image("C:\\Users\\Nivedha\\Desktop\\Amrita\\Sem 2\\Java\\Projects Final\\image1.jpg");
    ...
    private TableView<String[]> createTableView() {
        ...
        // Load data from file
        ObservableList<String[]> data = loadDataFromFile();
        tableView.setItems(data);

        return tableView;
    }

    private ObservableList<String[]> loadDataFromFile() {
